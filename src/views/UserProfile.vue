      ...
      <div class="container-fluid d-flex align-items-center">
        <div class="row">
          <div class="col-lg-7 col-md-10">
            <h1 class="display-2 text-white">Hello Etiqa User</h1>
            <p class="text-white mt-0 mb-5">
              This is test assessment profile page for etiqa frontend development with vuejs/ tailwinds css.
            </p>
          ...
          <div class="card card-profile shadow">
            ...
            <div class="card-body pt-0 pt-md-4">
              ...
              <div class="text-center">
                <h3>
                  Abu bin Atan<span class="font-weight-light">, 27</span>
                </h3>
                <hr class="my-4" />
                <a href="#">Show more</a>
              </div>
